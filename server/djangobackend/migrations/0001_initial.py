# Generated by Django 3.1.5 on 2021-02-05 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blogpic', models.ImageField(null=True, upload_to='')),
                ('body', models.TextField(max_length=5000)),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='date posted')),
                ('date_updated', models.DateTimeField(auto_now=True, verbose_name='date updated')),
                ('blog_author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='djangobackend.author')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='date posted')),
                ('date_updated', models.DateTimeField(auto_now=True, verbose_name='date updated')),
                ('blog', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='djangobackend.blog')),
            ],
        ),
    ]
